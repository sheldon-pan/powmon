...
typedef struct {
    ...
    uint64_t clk_ref ;
    uint64_t instr_last ;
    uint64_t clk_curr_last;
    uint64_t clk_ref_last ;
    uint64_t C3_last;
    uint64_t C3;
    uint64_t C6_last;
    uint64_t C6;
    ...
    uint64_t mperf_last ;
    uint64_t mperf ; 
    long long int tsc_diff; 
    long long int instr_diff;
    long long int clk_curr_diff;
    long long int clk_ref_diff;
    long long int C3_diff;
    long long int C6_diff;
    long long int aperf_diff;
    long long int mperf_diff;
...
typedef struct {
    ...
    long long int uclk_diff;
    long long int C3_diff;
    long long int C6_diff;
    long long int C2_diff;
    float pkgpow;
    float drampow;
    float uclk_MHz;
}per_cpu_data;
...
void read_msr_data_first(struct sys_data * sysd);
